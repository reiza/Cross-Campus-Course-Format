...
if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_configtext('format_uwishared/smiurl',
            new lang_string('smiurl', 'format_uwishared'),
            new lang_string('smiurldesc', 'format_uwishared'),
            '', PARAM_TEXT));

    $settings->add(new admin_setting_configselect('format_uwishared/smimappingcampusid',
    ...
    // $settings->add(new admin_setting_configtext('format_uwishared/smimappingcampusid',
    //         new lang_string('smimappingcampusid', 'format_uwishared'),
    //         new lang_string('smimappingcampusiddesc', 'format_uwishared'),
    //         '', PARAM_TEXT));
